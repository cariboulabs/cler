...
int main() {
    ...
    return 0;
}`,oe=`// Slim "Spike-like" spectrum analyzer GUI for USRP / HackRF / Pluto on CLER.
...
`,ce={hello_world:_,plots:P,polyphase_channelizer:D,mass_spring_damper:y,uhd_device:ee,spike:H,adsb_receiver:l,type_conflict:Q},pe={hello_world:ne,plots:ae,polyphase_channelizer:le,mass_spring_damper:re,uhd_device:ie,spike:oe,adsb_receiver:te,type_conflict:se},de=Object.keys(ce);export{ce as a,de as b,pe as f};
