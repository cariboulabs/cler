...
typedef void (*mode_s_callback_t)(mode_s_t *self, struct mode_s_msg *mm, void *context);

void mode_s_init(mode_s_t *self);
void mode_s_detect(mode_s_t *self, uint16_t *mag, uint32_t maglen, mode_s_callback_t cb, void *context);
