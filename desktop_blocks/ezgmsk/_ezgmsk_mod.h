...
typedef enum {
    ...
    EZGMSK_MOD_STATE_SYNCWORD,           
    EZGMSK_MOD_STATE_HEADER,
    EZGMSK_MOD_STATE_PAYLOAD,
...
//  _syncword_symbols       : syncword pattern (symbols)
//  _syncword_symbols_len   : syncword length in symbols
...
//  _header         : raw header data [size: _header_len x 1]
//  _header_len     : raw header length (bytes)
//  _payload        : raw payload data [size: _payload_len x 1]
