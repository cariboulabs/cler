...
| [<img src="misc/showcase/earshot.jpg" width="420">](desktop_examples/earshot) | **earshot** — the receiver in a browser tab, served by the box the SDR is plugged into (a Raspberry Pi will do). [Try it in your browser right now](https://cariboulabs.github.io/cler/demos/run/earshot/index.html) on the built-in simulator, or with no hardware locally: `earshot --source sim`. With a radio: `ssh -L 8080:127.0.0.1:8080 box` and pick the device from a list. HackRF, Pluto, USRP, CaribouLite, SoapySDR or a SigMF capture; records and plays back to SigMF. |
